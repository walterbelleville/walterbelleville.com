...
// send Mail
/*exports.sendMail = function(aMessage) {

    var firstName = aMessage.body.firstName;
    var lastName = aMessage.lastName;
    var email = aMessage.body.email;
    var subject = aMessage.body.subject;
    var emailMessage = aMessage.body.emailMessage;
    ...
    var mailOptions = {
        from: 'Walter Belleville <walterbell2331@gmail.com>', // sender address
        to: 'walterbell2331@gmail.com', // list of receivers. This is whoever you want to get the email when someone hits submit
        subject: 'New email from your website contact form:' + aMessage.body.subject, // Subject line
        text: 'Message: ' + aMessage.body.emailMessage + ' You may contact this sender at: ' + aMessage.body.email // plaintext body
